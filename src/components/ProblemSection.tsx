...
export function ProblemSection() {
  return (
    <>
      ...
      <section className="pt-14 pb-6 md:pt-20 md:pb-8 bg-[#fdf9f5] border-t border-slate-100" id="real-problem">
        <div className="max-w-[1160px] mx-auto px-4 sm:px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-14 items-center">

            {/* LEFT — Image with floating speech bubble cards matching reference graphic */}
            <div className="relative flex items-center justify-center min-h-[500px] sm:min-h-[560px]">
              <div className="relative w-full max-w-[560px] h-[520px] flex items-center justify-center">
                {/* Decorative faint circular ring path with dots behind */}
                ...
                {/* Faint clock graphic behind waiter head */}
                ...
                {/* Main waiter image — large and prominent */}
                {/* eslint-disable-next-line @next/next/no-img-element */}
                <img
                ...
                {/* Floating card 3: Kitchen — Middle Left (Floating outside left plates) */}
                ...
                {/* Floating card 4: Owner — Moved Upward closer to desk bell level */}
            ...
            <div>
              ...
              {/* Heading */}
              <h2 className="text-3xl sm:text-4xl lg:text-[42px] font-bold font-serif-heading text-slate-900 tracking-tight leading-[1.15] mb-8">
                <span className="whitespace-nowrap">The right person did not get</span>
                <br />
                <span className="whitespace-nowrap">the right information in time<span className="text-orange-600">.</span></span>
              </h2>
              ...
              <div className="space-y-5">
                ...
                <div className="flex items-center gap-4">
                  <div className="w-11 h-11 rounded-full bg-[#fff2e8] flex items-center justify-center flex-none">
                    <svg className="w-5 h-5 text-[#f95722]" viewBox="0 0 24 24" fill="currentColor">
                      <path d="M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm0 2c-2.67 0-8 1.34-8 4v2h16v-2c0-2.66-5.33-4-8-4z" />
                    </svg>
                  </div>
                  <span className="font-bold text-slate-900 text-base sm:text-lg w-28 flex-none">The guest</span>
                  <span className="text-orange-400 flex-none font-sans">→</span>
                  <span className="text-slate-600 text-sm sm:text-base">did not know what is in the dish.</span>
                </div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <span className="font-bold text-slate-900 text-base sm:text-lg w-28 flex-none">The kitchen</span>
                  <span className="text-orange-400 flex-none font-sans">→</span>
                  <span className="text-slate-600 text-sm sm:text-base">did not know about the allergy.</span>
                </div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <span className="font-bold text-slate-900 text-base sm:text-lg w-28 flex-none">The waiter</span>
                  <span className="text-orange-400 flex-none font-sans">→</span>
                  <span className="text-slate-600 text-sm sm:text-base">did not know the food was ready.</span>
                </div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <span className="font-bold text-slate-900 text-base sm:text-lg w-28 flex-none">The owner</span>
                  <span className="text-orange-400 flex-none font-sans">→</span>
                  <span className="text-slate-600 text-sm sm:text-base">did not know what was sold.</span>
                </div>
              </div>
